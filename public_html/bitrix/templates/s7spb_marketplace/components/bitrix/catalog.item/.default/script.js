(function (window){
	...
	window.JCCatalogItem.prototype = {
		...
		quantityUp: function()
		{
			if(this.obQuantity.value < parseInt($(this.obQuantity).data("moq")))
			{
				this.obQuantity.value = parseInt($(this.obQuantity).data("moq"));
			}
		...
		sendToBasket: function()
		{
			...
			// Добавил в количество учёт коробок
			this.basketParams.quantity = this.basketParams.quantity * parseInt($(this.obQuantity).data("pcs"));
...
function deleteFavorite(t, id) {
	// product-item
	$(t).closest('.product-item').parent().remove();
...
function toggleFavorite(t, id) {
	// tomble class
	// item-favorite-fill
	// item-favorite-icon
	if($(t).hasClass("item-favorite-fill")){
		$(t).removeClass("item-favorite-fill")
			.addClass("item-favorite-icon");
	}else{
		$(t).removeClass("item-favorite-icon")
			.addClass("item-favorite-fill");
	}
