...
$this->addExternalJs(SITE_TEMPLATE_PATH . "/assets/js/jquery.mask.min.js");
...
// MANAGER INJECTION
$arParams['MANAGER_CONNECT'] = Loc::getMessage('MANAGER_CONNECT');
$arParams['MANAGER_CONNECT_TITLE'] = Loc::getMessage('MANAGER_CONNECT_TITLE');
$arParams['MANAGER_CONNECT_PHONE'] = Loc::getMessage('MANAGER_CONNECT_PHONE');
$arParams['MANAGER_CONNECT_NAME'] = Loc::getMessage('MANAGER_CONNECT_NAME');
$arParams['MANAGER_CONNECT_SUCCESS'] = Loc::getMessage('MANAGER_CONNECT_SUCCESS');
// COMPANY INJECTION
$arParams['COMPANY_DATA'] = Loc::getMessage('COMPANY_DATA');
...
$arParams['MESS_ORDER_MANAGER_CONNECT'] = Loc::getMessage('ORDER_MANAGER_CONNECT_DEFAULT');
$arParams['MESS_ORDER_MANAGER_NOT_NEED'] = Loc::getMessage('ORDER_MANAGER_NOT_NEED_DEFAULT');
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" class="bx-soa-wrapper mb-4<?=$themeClass?>" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row" style="opacity: 0">
			...
			<div class="col-lg-8 col-md-7 bx-soa">
                ...
                <!--	COMPANY PROPS BLOCK	-->
                <div id="bx-soa-company" data-visited="false" class="bx-soa-section bx-active">
                    <div class="bx-soa-section-title-container d-flex justify-content-between align-items-center flex-nowrap">
                        <div class="bx-soa-section-title" data-entity="section-title">
                            <span class="bx-soa-section-title-count"></span><?=$arParams['COMPANY_DATA']?>
                        </div>
                        <div><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
                    </div>
                    <div class="bx-soa-section-content"></div>
				...
				<div style="display: none;">
					...
					<div id="bx-soa-company-hidden" class="bx-soa-section"></div>
